...
module.exports = (app, route) => {
  ...
  const items = [
    ...
    {
      heading: 'Discovery to determine requirements for a Learning Management /Induction & Onboarding System',
  ...
  route.draw(app).get(async (req, res) => {
    res.render(name, routeUtils.getViewData(res, { items: items }))
  })
}
